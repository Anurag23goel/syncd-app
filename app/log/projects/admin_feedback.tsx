...
const FeedbackForm = () => {
  ...
  const t = translations[language].modal.adminFeedback;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>3. {t.questionWithRating}</Text>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionText}>4. {t.questionWithOption}</Text>
          {[t.option1, t.option2, t.option3, t.option4].map((option) => (
            <TouchableOpacity
              key={option}
