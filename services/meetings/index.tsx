import {
   ...
   * @param meetingData - Meeting creation payload
   ...
   * @param authToken - User authentication token
   * @param meetingData - Meeting update payload
   * @returns Updated MeetingResponse
   */
  ...
  export async function deleteMeeting(
    ...
    try {
      ...
      const { data } = await axiosInstance.delete<ApiResponse<{ message: string }>>(url, {
        headers: {
          Authorization: `Bearer ${authToken}`, // ✅ Sending auth token in header
        },
      });
